...
import br.radio.DigitalWeb.BroadcastReceiver.BroadcastReceiverPlayPause;
import br.radio.DigitalWeb.Connect.CheckConnection;
...
public class  PlayerService extends MediaBrowserServiceCompat {
    ...
    @SuppressLint("StaticFieldLeak")
    public static CheckConnection conexao;
    @SuppressLint("StaticFieldLeak")
    ...
    public void onCreate() {
        ...
        conexao = new CheckConnection(context);

        focoAudio();

        if(SingletonUpdateStatus.getInstance().tempo == 0 && !Status.isErroAoConectar()){
                // ProgressBarTime();
